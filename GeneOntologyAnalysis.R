...
topgo_object <- function(ontology, gene_list) { #ontology: BP=biological process, MF=molecular function, CC=cellular component
...
# Fischer exact test -> first argument: topGOdata object, second and third: string, method and test statistic
