...
data_wt <- data_wt[ , c(1, 6)] #We only take the codon and average columns for WT
data_ko <- data_ko[ , c(1, 6)] #We only take the codon and average columns for KO
...
## Extract the relevant columns
data_plot <- data_plot[ , c(1, 4)] # codon and normalized columns -> see if there's a change in KO cells
